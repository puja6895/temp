      ...
      <div class="row">
        ...
        <!-- left column -->
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="POST" action="{{route('master.unit.store')}}">
            @csrf
              <div class="box-body">
                {{-- Unit Name --}}
                <div class="form-group {{ $errors->has('unit_name') ? ' has-error' : '' }}">
                  <label for="Company_Name">Unit Name</label>
                  <input name="unit_name" required type="text" class="form-control" id="name" placeholder="Enter Name Of Unit" value="{{old('unit_name') }}">
