      ...
      <div class="row">
        ...
        <!-- left column -->
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="POST" action="{{route('master.payment-mode.update')}}">
            @csrf
              <div class="box-body">
                {{-- Payment Mode Name --}}
                <div class="form-group {{ $errors->has('payment_mode') ? ' has-error' : '' }}">
                  <label for="Company_Name">Unit Name</label>
                  <input name="payment_mode" required type="text" class="form-control" id="name" placeholder="Enter Payment Mode" value="{{$payment_mode->payment_mode }}">
