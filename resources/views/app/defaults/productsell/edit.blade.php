          ...
          <div class="box box-primary">
            ...
            @csrf
              ...
              <div class="form-group {{ $errors->has('purchase_price') ? ' has-error' : '' }}">
                  ...
                  <span style="color: red;">*</span>
                  <input name="purchase_price" required type="number" class="form-control" id="purchase_price" placeholder="Enter Purchase Price Per Unit" value="{{$default_product_sell->purchase_price }}">
