        ...
        <!-- left column -->
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Purchaser</h3>
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="POST" action="{{route('purchaser.store')}}">
            @csrf
              <div class="box-body">
                {{-- Purchaser Name --}}
                <div class="form-group {{ $errors->has('purchaser_name') ? ' has-error' : '' }}">
                  ...
                  <input name="purchaser_name" required type="text" class="form-control" id="purchaser_name" placeholder="Enter Name Of Purchaser" value="{{old('purchaser_name') }}">
                ...
                <div class="form-group {{ $errors->has('purchaser_email') ? ' has-error' : '' }}">
                  ...
                  <input name="purchaser_email" type="text" class="form-control" id="purchaser_email" placeholder="Enter Email Of Purchaser" value="{{old('purchaser_email') }}">
              ...
              <div class="form-group {{ $errors->has('purchaser_mobile') ? ' has-error' : '' }}">
                  ...
                  <span style="color: red;">*</span>
                  <input name="purchaser_mobile" required type="text" class="form-control" id="purchaser_mobile" placeholder="Enter Mobile Of Purchaser" value="{{old('purchaser_mobile') }}">
              ...
              <div class="form-group {{ $errors->has('purchaser_address') ? ' has-error' : '' }}">
                  ...
                  <input name="purchaser_address" type="text" class="form-control" id="purchaser_address" placeholder="Enter Address Of Purchaser" value="{{old('purchaser_address') }}">
              ...
              <div class="form-group {{ $errors->has('company') ? ' has-error' : '' }}">
                  ...
                  <input name="company" type="text" class="form-control" id="company" placeholder="Enter Company Of Purchaser" value="{{old('company') }}">
